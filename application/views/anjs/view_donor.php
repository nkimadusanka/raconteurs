...
<div ng-controller="donor_table">
	...
	<div class = "row">
		<div class="col-md-12">
			<h1>Manage Member<small> Manage Member details</small></h1>
		</div>
	</div>
	<hr/>
	<div class = "row">
		<div class = "col-md-2">
			<center>Search member by email</center>
		</div>
		<div class = "col-md-10">
	...
	<div class="row">
		<div class="div_scroll list-group col-md-12">
			<a class="list-group-item" ng-repeat="donor in donors |filter: email">
				<div class = "row"> 
					<div class = "col-md-9">
