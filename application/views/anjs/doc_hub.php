...
<br />
<div ng-controller="doc_hub_table">
	<div class = "row">
		<div class="col-md-12">
			<h1>Doc-Hub<small> Search Files</small></h1>
		</div>
	</div>
	<hr/>
	<div class = "row">
		...
		<div class = "col-md-4">
			 <select class="form-control" ng-model = "province">
					...
					<option value="cp">.png (Portable Network Graphic)</option>
					<option value="ep">.pdf (Portable Document Format)</option>
					<option value="ncp">.txt (Plain Text File)</option>
					<option value="np">.xls (Excel Spreadsheet)</option>
					<option value="nwp">.ppt (PowerPoint Presentation)</option>				
			</select>
		</div>
	</div>
	<br/>
	<div class="row">
		<div class="div_scroll list-group col-md-12">
			<a class="list-group-item" ng-repeat="center in centers | filter:address2|filter:province">
				<div class = "row"> 
					<div class = "col-md-9">
						<img class="pull-left" src="<?php echo base_url()?>icons/defualt/file.png">
						<h4 class="list-group-item-heading"><b>&nbsp;Name:</b>{{ center.address1 }}</h4>
						<p class="list-group-item-text"><b>&nbsp;&nbsp;Upload by: </b>{{center.address2 }} <b> Type: </b>{{ center.type }}</p>
					</div>
					<div class = "col-md-3">
						<div class = "row">
							<div class = "col-md-6">
