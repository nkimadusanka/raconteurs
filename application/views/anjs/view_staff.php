...
<div ng-controller="staff_table">
	<div class = "row">
		<div class="col-md-12">
			<h1>Manage Group Moderator<small> Manage Group Moderator</small></h1>
		</div>
	</div>
	<hr/>
	<div class="row">
		...
		<div class = "col-md-2">
			 <select class="form-control" ng-model = "type">
					...
					<option value="as">Moderator Admin</option>
				...
				<div class="row">
					<div class="col-md-9">
						...
						<p class="list-group-item-text">
							...
							"Male" : "Female"}} 
							Type:<span ng-switch on = "employee.type">
									<span ng-switch-when="a"> Admin</span>
									<span ng-switch-when="as"> Moderator Admin</span>
									<span ng-switch-when="s"> Moderator</span>
								</span>
							</p>
					</div>
					<div class="col-md-3">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 id="lTitle" class="modal-title">View Moderator Details</h4>
					</div>
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<span ng-switch on = "type">
									<span ng-switch-when="a">Admin</span>
									<span ng-switch-when="sa">Moderator Admin</span>
									<span ng-switch-when="s">Moderator</span>
								</span>
								</h5>
							</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 id="lTitle" class="modal-title">Update Moderator Details</h4>
					</div>
					<div id="lContent" class="modal-body">
