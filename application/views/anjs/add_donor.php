<div class="page-header">
  <h1>Add New member to System <small>Enter details about member</small></h1>
</div>
<br/>
...
<div class="form-group">
        <div class="row">
            ...
            <div class="col-md-3 selectContainer" style="display:none;">
            ...
            <div class="col-md-6 selectContainer">
                <label class="control-label">Interst Group</label>
<?php if($centers != null){?>
